...
const products = [
  { name: 'Giriraj Screw', MOQ: '80 pc', image: "/72.jpg", rating: 4.8, rate: 10, info:'Lorem ipsum dolor sit amet, consectetur adipisicing elit. Consequuntur non earum repudiandae ipsa reprehenderit quaerat, quo a cupiditate, voluptatibus voluptates, dolores nam accusantium error, modi iure itaque totam labore.' },
  { name: 'Metal Screw', MOQ: '80 pc', image: "/82.jpg", rating: 4.8, rate: 20, info:'Lorem ipsum dolor sit amet, consectetur adipisicing elit. Consequuntur non earum repudiandae ipsa reprehenderit quaerat, quo a cupiditate, voluptatibus voluptates, dolores nam accusantium error, modi iure itaque totam labore.'  },
...
<section className='prodinfo' >
      ...
      {/* Alert component for showing success message */}
      {showAlert && (
        <Alert variant="success" onClose={() => setShowAlert(false)} dismissible>
          {`${selectedProduct && selectedProduct.name} added to get Quotes`}
        </Alert>
      )}
    </section>
  );
