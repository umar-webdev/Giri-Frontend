...
const products = [
  { name: 'PVC Gasket', MOQ: '80 pc', image: "/64.jpg", rating: 4.8, rate: 10, info:'PRODUCT ID: GT-275' },
  { name: 'PVC Jumbo', MOQ: '80 pc', image: "/73.jpg", rating: 4.8, rate: 20, info:'PRODUCT ID: GT-276'  },
  { name: 'PVC Clear', MOQ: '80 pc', image: "/68.jpg", rating: 4.8, rate: 30, info:'PRODUCT ID: GT-277'  },
  { name: 'PVC Gasket Sami EPDM', MOQ: '80 pc', image: "/65.jpg", rating: 4.8, rate: 50, info:'PRODUCT ID: GT-278'  },
  // { name: 'PVC Gasket special ivory', MOQ: '80 pc', image: pvc5, rating: 4.8, rate: 20, info:'PRODUCT ID: GT-279' },
 ];
